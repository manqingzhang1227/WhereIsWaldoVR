...
public:
  ...
  // render the mesh
  void Draw( GLuint shaderId, const glm::mat4 &projection,
             const glm::mat4 &view, const glm::mat4 &toWorld,
             GLint isHighlighted ) {
    ...
    for( unsigned int i = 0; i < textures.size(); i++ ) {
      ...
      glUniform1i( glGetUniformLocation( shaderId, ( name + number ).c_str() ),
                   i );
